...
import {
  ...
  Settings, Cloud, HardDrive, ScrollText,
} from "lucide-react";
...
const MAIN_NAV = [
  ...
  { href: "/audit-log",           icon: ScrollText,      label: "Audit Trail" },
  ...
  return (
    <aside className={cn(
      ...
      <div className={cn(
        ...
        <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-[#0a1424] border border-blue-500/30 shrink-0 overflow-hidden">
          <Image
            src="/images/cloud-securelens-logo.png"
            alt="Cloud SecureLens"
            width={24}
            height={24}
            unoptimized
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <p className="text-sm font-bold text-white leading-tight truncate">
              Secure<span className="text-blue-400">Lens</span>
            </p>
            <p className="text-[10px] text-slate-500 truncate">Security Audit</p>
          </div>
        )}
      </div>
